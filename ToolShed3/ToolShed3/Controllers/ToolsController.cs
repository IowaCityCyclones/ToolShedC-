...
namespace ToolShed3.Controllers
{
    ...
    {
        private readonly ToolShedContext _context;
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var tool = await _context.Tool.SingleOrDefaultAsync(m => m.ID == id);
            if (tool == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("brand,toolbox,hasToolbox,ID,name,price,SKU,acqDate")] Tool tool)
        {
            if (id != tool.ID)
            {
                return NotFound();
